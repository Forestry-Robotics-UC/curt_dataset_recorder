...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '1920,1080,20', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.global_time_enabled',   'default': 'false', 'description': 'Global Time'},
                           ...
                           {'name': 'depth_module.color_profile',   'default': '1920,1080,30', 'description': 'Depth module color stream profile for d405'},
